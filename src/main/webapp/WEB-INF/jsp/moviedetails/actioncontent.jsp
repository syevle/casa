		...
		<form:form method="post" action="${action}" commandName="frmObject" name="frm" id="frm" class="formular">
			...
			<table>
				...
				<tr>
					...
					<td><form:input path="relDate" readonly="${readonly}"  /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>					
		               ...
		               <c:if test="${readonly == false}">
		                	<form:select path="genre1" items="${genreList}" />
		               </c:if>
	                </td>
					...
					<td>					
		               ...
		               <c:if test="${readonly == false}">
		                	<form:select path="genre2" items="${genreList}" />
		               </c:if>
	                </td>
				</tr>
				<tr>
					...
					<td>					
		               ...
		               <c:if test="${readonly == false}">
		                	<form:select path="genre3" items="${genreList}" />
		               </c:if>
	                </td>
					...
					<td>					
		               ...
		               <c:if test="${readonly == false}">
		                	<form:select path="genreExtra" items="${genreList}" />
		               </c:if>
	                </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><form:input path="entryDt" readonly="${readonly}"  /></td>
