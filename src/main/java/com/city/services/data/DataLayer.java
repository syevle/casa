...
public interface DataLayer {
	...
	*/
     ...
     * @param id Identifier to delete
     */
    void deleteMovieDetails(final String id);
     ...
     * @return a Site object
     */
    MovieDetails loadMovieDetails(final String id);
    /**
     * Loads the given Object.
     * @param id Id to load
     * @return An object of type T
     */
    MovieDetails getMovieDetails(final String id); 
    
    /** Deletes an object of a given Id. 
     * Will load the object internally so consider using delete (Site obj) directly
     * @param id Identifier to delete
     */
    void deleteCreator(final String id);
     ...
     * @return a Site object
     */
    Creator loadCreator(final String id);
    /**
     * Loads the given Object.
     * @param id Id to load
     * @return An object of type T
     */
    Creator getCreator(final String id);  
     ...
     * @param id Identifier to delete
     */
    void deleteDirector(final String id);
     ...
     * @return a Site object
     */
    Director loadDirector(final String id);
    /**
     * Loads the given Object.
     * @param id Id to load
     * @return An object of type T
     */
    Director getDirector(final String id);  
    
    /** Deletes an object of a given Id. 
     * Will load the object internally so consider using delete (Site obj) directly
     * @param id Identifier to delete
     */
    void deleteStarcast(final String id);
     ...
     * @return a Site object
     */
    Starcast loadStarcast(final String id);
    /**
     * Loads the given Object.
     * @param id Id to load
     * @return An object of type T
